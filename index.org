...
But it's too hard to read now! That's one of the advantages of ASCII: our brains have a lot of practice recognizing letters, but not a lot of practice recognizing this project's new shapes. I'm going to make the tile sizes larger to compensate for this.

I kept the colors from the ASCII output but will want to adjust some of these colors to better fit the sprites.
