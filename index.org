...
Drawing all the objects on a tile also fixed a bug I had from last year's project: if a monster is over the stairs, and you walk out of view, the stairs should be visible but are not.
