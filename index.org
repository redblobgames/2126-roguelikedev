...
I'd like to try "thin walls". I've wanted to try thin walls for a long time, and this is my chance. I'll represent them the way I described in [[href:/grids/edges/][this article]]. This will mean I can't use ROT.js's dungeon generator, and have to write my own. I think this will take most of week 2. It will also mean I can't use ROT.js's field of view algorithm, and have to write my own, maybe starting with [[/articles/visibility/][this]]. I think this may take much of week 3.
